...
from workflowforge import (
    Workflow, Job, action, run, on_push,
    pipeline, stage, agent_docker,
    buildspec, phase, environment,
    OllamaClient
)
...
def github_workflow_with_readme():
    ...
    job.add_step(action("actions/setup-python@v5", 
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"❌ Error: {e}")
        print("Note: If Ollama is not available, template-based READMEs will be generated")