...
from workflowforge import (
    pipeline, stage, agent_docker,
    git_checkout, docker_run, slack_notify, email_notify,
    archive_artifacts, publish_junit
)
...
# Add parameters
jp.add_parameter("string", "BRANCH_NAME", defaultValue="main", description="Branch to build")
jp.add_parameter("choice", "ENVIRONMENT", choices=["dev", "staging", "prod"], description="Target environment")
...
docker_stage.add_step(docker_run(
    "docker:latest", 
...
jp.post = {
    "success": [
        ...
        email_notify("team@company.com", "Build Success", "Build completed successfully")
    ],
    "failure": [
