...
class PipelineVisualizer(BaseModel):
    ...
    output_format: str = Field(default="png", description="Output format (png, svg, pdf)")
    ...
    def _create_github_dot(self, workflow) -> str:
        ...
        dot.append(f'    trigger [label="Triggers\\n{triggers}", shape=ellipse, color=green];')
