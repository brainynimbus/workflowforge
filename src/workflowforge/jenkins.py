...
class JenkinsStage(BaseModel):
    ...
    parallel: Optional[Dict[str, "JenkinsStage"]] = Field(None, description="Parallel stages")
...
class JenkinsAgent(BaseModel):
    ...
    label: Optional[str] = Field(None, description="Agent label")
    docker: Optional[str] = Field(None, description="Docker image")
    any: Optional[bool] = Field(None, description="Any available agent")
...
class JenkinsPipeline(BaseModel):
    ...
    agent: JenkinsAgent = Field(default_factory=lambda: JenkinsAgent(any=True), description="Pipeline agent")
    stages: List[JenkinsStage] = Field(default_factory=list, description="Pipeline stages")
    environment: Optional[Dict[str, str]] = Field(None, description="Environment variables")
    tools: Optional[Dict[str, str]] = Field(None, description="Tools configuration")
    options: Optional[List[str]] = Field(None, description="Pipeline options")
    triggers: Optional[List[str]] = Field(None, description="Pipeline triggers")
    post: Optional[Dict[str, List[str]]] = Field(None, description="Post actions")
    libraries: Optional[List[str]] = Field(None, description="Shared libraries")
    parameters: Optional[List[Dict[str, Any]]] = Field(None, description="Pipeline parameters")
    ...
    def save(self, filepath: str = "Jenkinsfile", generate_readme: bool = False, use_ai: bool = True, generate_diagram: bool = True) -> None:
